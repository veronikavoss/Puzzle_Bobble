...
class Asset:
    ...
    def get_sound(self):
        ...
        self.bubble_score_sound=pygame.mixer.Sound(os.path.join(SOUND_PATH,'BallsScore.wav'))
        self.bubble_score_sound.set_volume(SFX_VOLUME-0.9)
        self.extra_bubble_score_sound=pygame.mixer.Sound(os.path.join(SOUND_PATH,'ExtraBallsScore.wav'))
        self.extra_bubble_score_sound.set_volume(SFX_VOLUME-0.8)
